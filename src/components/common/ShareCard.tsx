  ...
  return (
    <div className="fixed -left-[10000px] top-0"> {/* Render off-screen for capture */}
      <div 
        ...
        style={{
          background: 'linear-gradient(135deg, #f0f2f5 0%, #e6eef5 100%)',
          borderRadius: '40px',
      ...
      >
        ...
        <div className="w-full flex justify-between items-start z-10">
          <div className="flex flex-col max-w-[85%]">
            ...
            <h1 className="text-lg font-display font-bold text-apple-ink leading-tight break-keep">{scenarioName}</h1>
          </div>
          {/* Brand Icon */}
        ...
        <div className="w-full z-10 bg-white/40 rounded-3xl border border-white/50 p-4 mt-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex flex-col items-center text-center flex-1">
              ...
              <span className="text-[11px] font-bold text-apple-ink break-keep">{SnowballEngine.formatBigNumber(pessimisticAsset, currency, true)}</span>
            </div>
            {/* Divider & Arrow */}
            ...
            <div className="flex flex-col items-center text-center flex-1">
              ...
              <span className="text-[11px] font-bold text-apple-ink break-keep">{SnowballEngine.formatBigNumber(optimisticAsset, currency, true)}</span>
            </div>
          </div>
        </div>
